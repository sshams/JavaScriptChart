...
puremvc.define(
{
    name: 'view.components.TagObject',
...
},
{
    ...
    removeEventHandler: function(element, event, method, useCapture) {
        if(element.removeEventListener) {
            event = event.replace('on', '');
            element.removeEventListener(event, method, useCapture == true ? true : false);
...
{
    MouseEvent: {CLICK: "click", MOUSE_OVER: "mouseover", MOUSE_OUT: "mouseout", MOUSE_DOWN: "mousedown", MOUSE_UP: "mouseup", MOUSE_MOVE: "mousemove", BLUR: "blur", FOCUS: "focus"},
